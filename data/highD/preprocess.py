...
SLOT_WEIGHTS_PRE_LC = [
    [0.2663, 0.2357, 0.0000, 0.0000, 0.0000, 0.3482, 0.1095, 0.2547],  # G0 leftmost→right
    [0.1921, 0.1699, 0.1650, 0.1198, 0.1580, 0.1907, 0.1304, 0.1739],  # G1 middle→right
    [0.2721, 0.1286, 0.2973, 0.0890, 0.1010, 0.1926, 0.0837, 0.1163],  # G2 middle→left
    [0.3509, 0.1685, 0.4263, 0.1818, 0.1949, 0.0000, 0.0000, 0.0000],  # G3 rightmost→left
]

# LC-in-history case: post-LC weights per LC group (G0-G3)
SLOT_WEIGHTS_POST_LC = [
    [0.2151, 0.1893, 0.1848, 0.1072, 0.1603, 0.2007, 0.0792, 0.1531],  # G0 leftmost→right
    [0.2764, 0.2589, 0.2880, 0.1845, 0.2543, 0.1847, 0.1775, 0.1753],  # G1 middle→right
    [0.3571, 0.2584, 0.1785, 0.0000, 0.1589, 0.2882, 0.2036, 0.2177],  # G2 middle→left
    [0.2161, 0.1781, 0.1911, 0.1581, 0.1668, 0.2509, 0.2002, 0.2153],  # G3 rightmost→left
]
